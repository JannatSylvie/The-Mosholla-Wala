...
{
	public partial class DeliveredSpices : Form
	{
		public DeliveredSpices()
		{
			InitializeComponent();
		}
		...
		private void DeliveredSpices_Load(object sender, EventArgs e)
		{
			// TODO: This line of code loads data into the 'theMoshollaWalaDataSet6.DeliveredSpices' table. You can move, or remove it, as needed.
			this.deliveredSpicesTableAdapter1.Fill(this.theMoshollaWalaDataSet6.DeliveredSpices);
			labelUserName.Text = SignIn.PassingText;
			// TODO: This line of code loads data into the 'theMoshollaWalaDataSet4.DeliveredSpices' table. You can move, or remove it, as needed.
			this.deliveredSpicesTableAdapter.Fill(this.theMoshollaWalaDataSet4.DeliveredSpices);
		...
		private void pictureBoxSearch_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				{
					string query = "select * from DeliveredSpices where SpiceId like '%" + textBoxSearch.Text + "%' or SpiceName like '%" + textBoxSearch.Text + "%' or Brand like '%" + textBoxSearch.Text + "%' or Price like '%" + textBoxSearch.Text + "%' or Customer_UserName like '%" + textBoxSearch.Text + "%'";
					SqlDataAdapter sd = new SqlDataAdapter(query, con);
					sd.Fill(dts);
					dataGridViewDeliveredSpices.DataSource = dts;
					dataGridViewDeliveredSpices.Refresh();
