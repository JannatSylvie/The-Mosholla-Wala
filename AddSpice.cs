...
{
	public partial class AddSpice : Form
	{
		public AddSpice()
		{
			InitializeComponent();
		...
		private void buttonAdd_Click(object sender, EventArgs e)
		{
			...
			if (textBoxSpiceId.Text != "" && textBoxSpiceName.Text != "" && textBoxBrand.Text != "" && textBoxPrice.Text != "")
			{
				try
				{
					...
					if (con.State == ConnectionState.Open)
					{
						...
						string query = "insert into SpiceInfoTable_User (SpiceId,SpiceName,Brand,Price)values('" + textBoxSpiceId.Text + "','" + textBoxSpiceName.Text + "','" + textBoxBrand.Text + "','" + textBoxPrice.Text + "')";

						SqlCommand sqcom = new SqlCommand(query, con);
						int value = sqcom.ExecuteNonQuery();
						MessageBox.Show("Spice added");
						clear();
					}
					else
					{
		...
		private void AddSpice_Load(object sender, EventArgs e)
		{
